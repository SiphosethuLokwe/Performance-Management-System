...
<body>
    ...
    <div id="login-form" class="container " style="background:white;">
        <h2 style="text-align:center;color:#a7d8de;">Student Login</h2>
        <form id="techer-login" action="#">
            <div calss="form-group">
                <input class="form-control" placeholder="Student Number">
            </div>
            <br>

            <div class="form-group">
                <input class="form-control" placeholder="ID Number">
            </div>

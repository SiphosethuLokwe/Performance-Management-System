                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-xl-inline-block">
                        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                            <span class="profile-text">Hello, Siphosethu Lokwe !</span>
                ...
                <i class="mdi mdi-plus"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="authr">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="addTeacher.html"> Add Teacher</a>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Subject Name"> </div>
                        ...
                        <div class="col-lg-5 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h3>Grade 12a Subjects</h3>
                                    <p>(View Reports For Each Subject)</p>
                                    <div class="wrapper d-flex justify-content-between">
                                        <div class="side-left dropdown">
                                            <a href="#" class="mb-2 dropbtn">Mathematics</a>
                                            <div class="dropdown-content">
                                                <a href="pages/charts/MathsChart.html">Daily</a>
                                                <a href="pages/charts/MathsChart.html">Weekly</a>
                                                <a href="pages/charts/MathsChart.html">Monthly</a>
                                            </div>
                                        </div>

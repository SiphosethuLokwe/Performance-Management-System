        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-8 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h3>Unpublished Quiz</h3>
                  <p>Press the button on <b>Action</b> to <b>Publish</b> the Quiz</p>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <p><b>Mathematics, Chapter 3, Solve for x<b /></ap>
                          </td>
                          <td>
                            <div>
                             <a class="btn btn-primary" href="publish-quiz2.html" role="button">Publish</a>
                        </button>
                            </div>
                          </td>
                        </tr>
